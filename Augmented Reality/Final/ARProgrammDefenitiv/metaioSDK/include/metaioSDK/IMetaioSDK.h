...
enum ECAMERA_TYPE
{
	...
	ECT_TRACKING =		1<<0,
	/// Camera parameters that are used for rendering
	ECT_RENDERING =		1<<1,
...
public:
	 ...
	 * In case camera prameters for the device are not loaded, the method will return false.
	 *
	 ...
	 * This is recommended on multicore devices.
	 */

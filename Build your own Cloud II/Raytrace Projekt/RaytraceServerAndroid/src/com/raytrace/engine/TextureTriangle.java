...
public class TextureTriangle implements Intersectable {
	...
	public TextureTriangle (float[] a, float[] b, float[] c, float[] ta, float[] tb, float[] tc, Bitmap texture) {
		this.a = a;
		this.b = b;
		this.c = c;
	...
	public TextureTriangle (float[] a, float[] b, float[] c, float[] ta, float[] tb, float[] tc, float[] na, float[] nb, float[] nc, Bitmap texture) {
		this.a = a;
		this.b = b;
		this.c = c;
	...
	public Intersection intersect(float[] origin, float[] direction) {
		...
		int textureColor = texture.getPixel(textureX, textureY);

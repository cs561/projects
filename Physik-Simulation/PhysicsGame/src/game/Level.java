...
class Level{
    ...
    private LevelContentProvider coordProvider;
    private Game game;
     
  
    Level(int levelNo, Game game, LevelContentProvider coordProvider){
    ...
    void createLevel(){
        surface = new Surface(this, coordProvider); 
        tower = coordProvider.getTowerElements(levelNo, this);
        bulletsLeft = coordProvider.getNumberOfBullets(levelNo);
    ...
    void addBullet(int dx, int dy, int actualForce, float actualAngle){
        bullets.add(new Bullet(this, dx, dy, actualForce)); 
        decreaseBulletsLeft();
    }
